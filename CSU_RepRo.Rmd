...
Peu d'utilisateurs sont des informaticiens et n'ont pas les réfléxes 
de développement logiciel.
L'apprentissage se fait par la communauté.
...
La science se doit d'être reproductible pour les données comme pour les analyses.
...
Les espaces et les accents sont embettants quand on partage nos dossiers
...
ajoute la notion de dépendance d'un package.
...
si beaucoup de function apparaissent -> faire un script externe
