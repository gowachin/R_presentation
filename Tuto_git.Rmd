...
```{r, engine='tikz', fig.ext = 'png', engine.opts = list(template = "tex/gitdags.tex"), echo = FALSE, eval=TRUE}
...
\begin{tikzpicture}
  \matrix (m)
    ...
    {
        &  &  &  \\
        % A.txt & A.txt & A.txt &  \\  % \textit{7f21c09}
        A1.txt & A1'.txt & A1''.txt &  \\  % \textit{7f21c09}
        A2.txt & A2'.txt &  & B.txt \\  % \textit{7f21c09}
        A2.txt &  & B1.txt & B1'.txt \\  % \textit{7f21c09}
        & C.txt & B2.txt &  \\  % \textit{7f21c09}
        & D.txt &  &  \\  % \textit{7f21c09}
    };
...
Ca devient vite le bordel... 12 versions dans un dossier ?
